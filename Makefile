#############################################################################
# Makefile for building: carver
# Generated by qmake (3.0) (Qt 5.7.0)
# Project:  carver.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile carver.pro
#############################################################################
...
CXXFLAGS      = -pipe -std=c++11 -Wall -pedantic -Wno-unknown-pragmas -O2 -march=x86-64 -mtune=generic -O2 -pipe -fstack-protector-strong -Wno-unused-variable -Wno-reorder -D_REENTRANT -fPIC $(DEFINES)
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = carver1.0.0
DISTDIR = /home/jan/cv/.tmp/carver1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-O1,--sort-common,--as-needed,-z,relro
LIBS          = $(SUBLIBS) -L/usr/local/lib -lopencv_core -lopencv_highgui -lopencv_imgcodecs -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
Makefile: carver.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents carver.cpp $(DISTDIR)/
...
carver.o: carver.cpp carver.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o carver.o carver.cpp
